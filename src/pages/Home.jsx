...
const Home = () => {
  ...
  useEffect(() => {
    ...
    let url = `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=5c8e33ae58b4b69af48f3444fd46fc74`

    if(search) {
      url=`https://api.themoviedb.org/3/search/movie?query=${search}&api_key=5c8e33ae58b4b69af48f3444fd46fc74`
    }
  ...
  return (
    <div className='p-4 pt-16'>
      ...
      transform -translate-x-1/2 z-10' onChange={(e) => {
